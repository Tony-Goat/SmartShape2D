...
@export var fill_texture: Texture = null: set = _set_fill_texture
@export var fill_texture_normal: Texture = null: set = _set_fill_texture_normal
...
@export var top_texture: Array[Texture]: set = _set_top_texture
@export var top_texture_normal: Array[Texture]: set = _set_top_texture_normal

@export var left_texture: Array[Texture]: set = _set_left_texture
@export var left_texture_normal: Array[Texture]: set = _set_left_texture_normal

@export var right_texture: Array[Texture]: set = _set_right_texture
@export var right_texture_normal: Array[Texture]: set = _set_right_texture_normal

@export var bottom_texture: Array[Texture]: set = _set_bottom_texture
@export var bottom_texture_normal: Array[Texture]: set = _set_bottom_texture_normal

@export var use_corners: bool = true: set = _set_use_corners
# Textures for 90 angles
# Inner Angles
@export var top_left_inner_texture: Texture: set = _set_top_left_inner_texture
@export  var top_left_inner_texture_normal: Texture: set = _set_top_left_inner_texture_normal

@export  var top_right_inner_texture: Texture: set = _set_top_right_inner_texture
@export  var top_right_inner_texture_normal: Texture: set = _set_top_right_inner_texture_normal

@export  var bottom_right_inner_texture: Texture: set = _set_bottom_right_inner_texture
@export  var bottom_right_inner_texture_normal: Texture: set = _set_bottom_right_inner_texture_normal

@export  var bottom_left_inner_texture: Texture: set = _set_bottom_left_inner_texture
@export  var bottom_left_inner_texture_normal: Texture: set = _set_bottom_left_inner_texture_normal

# Outer Angles
@export  var top_left_outer_texture: Texture: set = _set_top_left_outer_texture
@export  var top_left_outer_texture_normal: Texture: set = _set_top_left_outer_texture_normal

@export  var top_right_outer_texture: Texture: set = _set_top_right_outer_texture
@export  var top_right_outer_texture_normal: Texture: set = _set_top_right_outer_texture_normal

@export  var bottom_right_outer_texture: Texture: set = _set_bottom_right_outer_texture
@export  var bottom_right_outer_texture_normal: Texture: set = _set_bottom_right_outer_texture_normal

@export  var bottom_left_outer_texture: Texture: set = _set_bottom_left_outer_texture
@export  var bottom_left_outer_texture_normal: Texture: set = _set_bottom_left_outer_texture_normal

@export var weld_edges: bool = false: set = _set_weld_edges

#TODO: Negative Range
#@export_range(-1.0, 1.0)
@export_range(0.0, 1.0) var render_offset = 0.0: set = _set_render_offset
...
#TODO: Negative Range
#@export_range(-1.5, 1.5)
@export_range(0.0, 1.5) var collision_offset: float = 0.0: set = _set_collision_offset

#The amount the first and final quads extend past the texture (Does not apply to closed shapes)
#TODO: Negative Range
#@export_range(-1.0, 1.0)
@export_range(0.0, 1.0) var collision_extends: float = 0.0: set = _set_collision_extends
